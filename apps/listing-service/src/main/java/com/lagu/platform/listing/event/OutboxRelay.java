...
/**
 * Delivers committed listing_outbox rows to Kafka, in creation order, at-least-once.
 * Same semantics as the other services' relays: broker failures stop the batch (retried
 * next tick), unreadable poison rows are parked, published rows purged after retention.
 */
@Component
