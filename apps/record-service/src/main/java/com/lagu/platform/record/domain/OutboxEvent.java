...
/**
 * A pending platform event, written in the same transaction as the record change that
 * produced it and published to Kafka asynchronously by {@code OutboxRelay}.
 */
@Entity
