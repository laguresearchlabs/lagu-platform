package com.lagu.platform.booking.config;
...
public class LoadBalancerConfig {
    ...
    // plain builder instead; service clients use @Qualifier to stay pinned to the load-balanced
    // one regardless of which bean is primary.
    @Bean
    @Primary
