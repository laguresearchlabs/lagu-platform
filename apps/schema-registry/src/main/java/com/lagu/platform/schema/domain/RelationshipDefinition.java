...
@Entity
@Table(name = "relationship_definition", schema = "schema_registry")
@Data
@NoArgsConstructor
public class RelationshipDefinition {
    ...
    @Column(name = "source_listing_type", nullable = false, length = 100)
    private String sourceListingType;

    @Column(name = "target_listing_type", nullable = false, length = 100)
